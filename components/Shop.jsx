        ...
        <div className='container mx-auto  py-20 '>
           <div className='mx-auto px-10 '>
                <div className='text-center '>
                    <h2 className='font-fairplay text-[22px] md:text-[57px] '>P | SHOP</h2>
                    </div>
                    <div className='w-full grid grid-cols-1 md:grid-cols-5 md:border-b-2 mt-[40px]    '>
                        {Menu4.map((item,index)=>(
                            ...
                            className={`col-span-1 py-1 md:py-5 cursor-pointer ${
                                selected === index ? 'text-[black] md:border-b-2 border-black' : 'text-[#707070] '
                              }`}
                    ...
                    <div className='py-5 md:py-20'>
                        ...
                        <div className='py-5 grid sm:grid-cols-1 md:grid-cols-2  lg:grid-cols-3  gap-5'>
                        {Menu3.map((item)=>(
                         <div key={item.title} 
                         className=" col-span-1  mt-[22px]" >
