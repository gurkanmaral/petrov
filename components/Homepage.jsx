...
const Homepage = () => {
  return (
    <section className=' relative flex flex-col w-full h-[352px]  md:h-[896px]  md:mt-[53px]  '>
      ...
      <div className='flex justify-end md:justify-center  h-[61px] md:h-[100px] w-full p-5 md:p-0 '>
         
          <div className='hidden md:flex gap-[40px] font-poppins text-[16px] py-4 '>
            <p>Hakkımızda</p>
            <p>Menu</p>
            <p>Shop</p>
            <p>İletişim</p>         
